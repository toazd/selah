...
Future<Map<int, Map<String, dynamic>>> loadNotesForChapter(
...
Future<Map<int, List<Map<String, dynamic>>>> loadHighlightsForChapter(
    String book, int chapter) async {
  final highlightsList =
      await HighlightsDatabase.getHighlightsForChapter(book, chapter);
